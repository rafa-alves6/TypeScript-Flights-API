...
2. **Validação de Dados (Zod):** Todas as rotas de escrita (POST/PUT) validam o _payload_ antes de chegar ao banco de dados para prevenir injeção de dados malformados.
